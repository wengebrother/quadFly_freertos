...
else if(bling_mode==3)//全灭
{
   ...
   if(((Last_GPS_Sate_Num!=GPS_Sate_Num)&&GPS_Sate_Num<=5)
      ...
      Bling_Set(&Light_4,1000,1000,0.5,0,GPIOA,WORK_LED,1);
   else if((Last_GPS_Sate_Num!=GPS_Sate_Num)&&GPS_Sate_Num<=9)
      Bling_Set(&Light_4,2000,2000,0.5,0,GPIOA,WORK_LED,1);
   else if((Last_GPS_Sate_Num!=GPS_Sate_Num)&&GPS_Sate_Num>=10)
      Bling_Set(&Light_4,2000,5000,0.5,0,GPIOA,WORK_LED,1);
...
void Quad_Start_Bling()
{
   ...
   Bling_Set(&Light_4,2000,1000,0.5,0,GPIOA,GPIO_Pin_5,1);
}
