...
void QuadShow()
{
 ...
 LCD_clear_L(0,4);write_6_8_number(0,4,Baro_Show.Raw_Pressure);write_6_8_number(80,4,Baro_Show.Offset_Pressure);

 LCD_clear_L(0,5);write_6_8_number(0,5,Gyro_Delta_Length);write_6_8_number(40,5,Baro_Show.High);
 LCD_clear_L(0,6);write_6_8_number(0,6,Time1_Delta.Time_Delta);write_6_8_number(40,6,NamelessQuad.Position[_YAW]);
 ...
 LCD_clear_L(0,5);  LCD_P6x8Str(0,5,"MX:");write_6_8_number(20,5,Mag_Offset_Read.x);write_6_8_number(80,5,Mag_Data[0]);
 LCD_clear_L(0,6);  LCD_P6x8Str(0,6,"MY:");write_6_8_number(20,6,Mag_Offset_Read.y);write_6_8_number(80,6,Mag_Data[1]);
 LCD_clear_L(0,7);  LCD_P6x8Str(0,7,"MZ:");write_6_8_number(20,7,Mag_Offset_Read.z);write_6_8_number(80,7,Mag_Data[2]);
 }
  else  if(Page_Number==2)
 {
  ...
  write_6_8_number(80,4,Total_Controller.High_Speed_Control.Expect);
  LCD_clear_L(0,5);
  LCD_P6x8Str(0,5,"Rol");
  ...
  LCD_clear_L(0,7);
  write_6_8_number(0,7,Total_Controller.Yaw_Angle_Control.Expect);
  write_6_8_number(55,7,Yaw);
  write_6_8_number(85,7,Total_Controller.Yaw_Gyro_Control.Expect);
 ...
 LCD_clear_L(0,1);
 write_6_8_number(0 ,1,Total_Controller.Pitch_Angle_Control.Kp);
 write_6_8_number(45,1,Total_Controller.Pitch_Angle_Control.Ki);
 write_6_8_number(80,1,Total_Controller.Pitch_Angle_Control.Kd);
 LCD_clear_L(0,2);
 LCD_P6x8Str(0,2,"W_Kp");
 LCD_P6x8Str(45,2,"W_Ki");
 LCD_P6x8Str(80,2,"W_Kd");
 LCD_clear_L(0,3);
 write_6_8_number(0,3,Total_Controller.Pitch_Gyro_Control.Kp);
 write_6_8_number(45,3,Total_Controller.Pitch_Gyro_Control.Ki);
 write_6_8_number(80,3,Total_Controller.Pitch_Gyro_Control.Kd);
 ...
 LCD_clear_L(0,5);
 write_6_8_number(0 ,5,Total_Controller.Yaw_Angle_Control.Kp);
 write_6_8_number(45,5,Total_Controller.Yaw_Angle_Control.Ki);
 write_6_8_number(80,5,Total_Controller.Yaw_Angle_Control.Kd);
 LCD_clear_L(0,6);
 LCD_P6x8Str(0,6,"W_Kp");
 LCD_P6x8Str(45,6,"W_Ki");
 LCD_P6x8Str(80,6,"W_Kd");
 LCD_clear_L(0,7);
 write_6_8_number(0,7,Total_Controller.Yaw_Gyro_Control.Kp);
 write_6_8_number(45,7,Total_Controller.Yaw_Gyro_Control.Ki);
 write_6_8_number(80,7,Total_Controller.Yaw_Gyro_Control.Kd);
 }
 ...
 LCD_clear_L(0,5);
 write_6_8_number(0 ,5,Total_Controller.High_Position_Control.Kp);
 write_6_8_number(45,5,Total_Controller.High_Position_Control.Ki);
 write_6_8_number(80,5,Total_Controller.High_Position_Control.Kd);

 LCD_clear_L(0,6);
 LCD_P6x8Str(0,6,"S_Kp");  LCD_P6x8Str(45,6,"S_Ki");  LCD_P6x8Str(80,6,"S_Kd");

 LCD_clear_L(0,7);
 write_6_8_number(0,7,Total_Controller.High_Speed_Control.Kp);
 write_6_8_number(45,7,Total_Controller.High_Speed_Control.Ki);
 write_6_8_number(80,7,Total_Controller.High_Speed_Control.Kd);
 }
 ...
 LCD_clear_L(0,0);
 LCD_P6x8Str(0,0,"A_E:");
 write_6_8_number(30,0,Total_Controller.Pitch_Angle_Control.Expect);
 write_6_8_number(30,1,Total_Controller.Roll_Angle_Control.Expect);

 LCD_clear_L(0,2);
 LCD_P6x8Str(0,2,"S_O:");
 write_6_8_number(30,2,Total_Controller.Latitude_Speed_Control.Control_OutPut);
 write_6_8_number(30,3,Total_Controller.Longitude_Speed_Control.Control_OutPut);

 LCD_clear_L(0,4);
 LCD_P6x8Str(0,4,"S_E:");
 write_6_8_number(30,4,Total_Controller.Latitude_Speed_Control.Expect);
 write_6_8_number(30,5,Total_Controller.Longitude_Speed_Control.Expect);

 LCD_clear_L(0,6);
 LCD_P6x8Str(0,6,"S_F:");
 write_6_8_number(30,6,Total_Controller.Latitude_Speed_Control.FeedBack);
 write_6_8_number(30,7,Total_Controller.Longitude_Speed_Control.FeedBack);
 }
 ...
 LCD_clear_L(0,1);
 write_6_8_number(0,1,DataMag.x);
 write_6_8_number(40,1,DataMag.y);
 write_6_8_number(70,1,DataMag.z);
 LCD_clear_L(0,2);
 ...
 LCD_clear_L(0,4);
 write_6_8_number(0,4,Baro_Show.Filter_Pressure);
 write_6_8_number(70,4,Baro_Show.High);
 }
  else if(Page_Number==13)//加速度矫正显示页
 {
 ...
 LCD_clear_L(0,7);  LCD_P6x8Str(0,7,"ch8:");write_6_8_number(25,7,PPM_Databuf[7]);write_6_8_number(55,7,RC_Calibration[7].max);write_6_8_number(90,7,RC_Calibration[7].min);
   ...
   else if(Page_Number==14)//电调行程校准显示页
 {
